...
module.exports = exports = class AppKitTextField extends AppKitControl {
  ...
  get truncatesLastVisibleLine() {
    return binding.textFieldTruncatesLastVisibleLine(this._tag)
  }

  set truncatesLastVisibleLine(truncatesLastVisibleLine) {
    binding.textFieldTruncatesLastVisibleLine(this._tag, truncatesLastVisibleLine)
  }
